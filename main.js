...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SaveDecisionTitle':
				return ($elm$core$String$trim(model.decisionTitle) !== '') ? _Utils_update(
					model,
					{titleLocked: true}) : model;
			case 'EditDecisionTitle':
				return _Utils_update(
					model,
					{titleLocked: false});
				...
				return _Utils_update(
					model,
					{
						options: A2(
							...
							function (option) {
								return !_Utils_eq(option.id, optionId);
							},
							model.options)
					});
			case 'UpdateCurrentCriteria':
				var newCriteria = msg.a;
				return _Utils_update(
					model,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$AddCriteria)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Add Criteria')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick(
											$author$project$Main$DeleteCriteria(criteria.id))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Delete')
